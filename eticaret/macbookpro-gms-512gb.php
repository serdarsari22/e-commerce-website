	...
	<div class="row">
		<div class=""><!--Main content-->
			...
			<div class="row">
				<div class="col-md-6">
					<div class="dt-img">
						<a ><img src="images/bilgisayar/macbookpro-gms.png" alt="" class="img-responsive"></a>
					</div>
					<!-- <div class="thumb-img">
				...
				<div class="col-md-6 det-desc">
					<div class="productdata"><br><br>
						<div class="infospan"><span class="title">Apple MackBook PRO M1 512GB SSD Gümüş</span></div><br><br>
						<div class="infospan">Marka : <span>APPLE</span></div><br>
						<div class="infospan">Hafıza : <span>512GB SSD</span></div><br>
						<div class="infospan">Renk : <span>Gümüş</span></div><br><br>
