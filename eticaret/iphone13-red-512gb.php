...
<div class="container">
	<div class="row">
		<div class=""><!--Main content-->
			...
			<div class="row">
				<div class="col-md-6">
					<div class="dt-img">
						<a ><img src="images/telefon/iphone13-productred.png" alt="" class="img-responsive"></a>
					</div>
					<!-- <div class="thumb-img">
				...
				<div class="col-md-6 det-desc">
					<div class="productdata"><br><br>
						<div class="infospan"><span class="title">Apple Iphone 13 512gb Kırmızı</span></div><br><br>
						<div class="infospan">Marka : <span>APPLE</span></div><br>
						<div class="infospan">Hafıza : <span>512gb</span></div><br>
						<div class="infospan">Renk : <span>Kırmızı</span></div><br><br>
 ...
 -->
								<!-- <div class="form-group">
									...
									<span class="title">27.399,00</span>												<!-- 	<div class="clearfix"></div> -->
