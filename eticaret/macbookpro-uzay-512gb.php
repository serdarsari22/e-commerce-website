...
<div class="container">
	<div class="row">
		<div class=""><!--Main content-->
			...
			<div class="row">
				<div class="col-md-6">
					<div class="dt-img">
						<a ><img src="images/bilgisayar/macbookpro-uzay.png" alt="" class="img-responsive"></a>
					</div>
					<!-- <div class="thumb-img">
				...
				<div class="col-md-6 det-desc">
					<div class="productdata"><br><br>
						<div class="infospan"><span class="title">Apple MackBook PRO M1 512GB SSD Uzay Gri</span></div><br><br>
 ...
 -->
							...
							<span class="title">41.999,00</span>	<div class="spacer"></div>
