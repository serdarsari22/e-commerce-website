      ...
      <div class="animate form login_form">
        <section class="login_content">
          ...
          <form action="../netting/islem.php" method="POST">
            ...
            <div>
            <button style="width: 100%; background-color: #f27a1a; color:white;" type="submit" name="admingiris" class="btn btn-default"> Giriş Yap</button>
            ...
            <div class="separator">
             ...
             ?>
              ...
              <div>
                <h1><i class="fa fa-paw"></i> E-TİCARET SİTESİ</h1>
                <p>©2017 E-Ticaret Sürümü</p>
              </div>
            </div>
          </form>
