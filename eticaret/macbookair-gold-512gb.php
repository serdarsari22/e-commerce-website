...
<div class="container">
	<div class="row">
		<div class=""><!--Main content-->
			...
			<div class="row">
				<div class="col-md-6">
					<div class="dt-img">
						<a ><img src="images/bilgisayar/macbook-air-gold.png" alt="" class="img-responsive"></a>
					</div>
					<!-- <div class="thumb-img">
				...
				<div class="col-md-6 det-desc">
					<div class="productdata"><br><br>
						<div class="infospan"><span class="title">Apple MackBook PRO M1 512GB SSD Gold</span></div><br><br>
						<div class="infospan">Marka : <span>APPLE</span></div><br>
						<div class="infospan">Hafıza : <span>512GB SSD</span></div><br>
						<div class="infospan">Renk : <span>Gold</span></div><br><br>
 ...
 -->
								...
								<span class="title">23.999,00</span>
