	...
	<div class="row">
		<div class=""><!--Main content-->
			...
			<div class="row">
				<div class="col-md-6">
					<div class="dt-img">
						<a><img src="images/telefon/iphone13-pro-gold.png" alt="" class="img-responsive"></a>
					</div>
					<!-- <div class="thumb-img">
				...
				<div class="col-md-6 det-desc">
					<div class="productdata"><br><br>
						<div class="infospan"><span class="title">Apple Iphone 13 512gb Gold</span></div><br><br>
